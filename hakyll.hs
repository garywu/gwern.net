...
--   Broken URLs must be valid Haskell strings, non-URL-escaped valid POSIX filenames, and relative links,
...
--   (Target URLs can be absolute or relative, but should be URL-escaped.) So broken incoming links like "http://www.gwern.net/foo/" which should be
...
--   An example of a valid tuple would be `("/Black-market archive", "/Black-market%20archives")`.
...
createRedirect working = "<!DOCTYPE html><html><head><meta charset=\"utf-8\"/><meta name=\"generator\" content=\"hakyll\"/>" ++
